% Documento: Folha de aprovação - fica logo após a folha de rosto e contém as informações da banca, junto dos espaços para assinatura banca
...
\begin{tabular}{cc}
	\assinatura{\textbf{\imprimirorientador} \\ \imprimirinstOrientador \\ (Orientador)}&\\
		%\assinatura{\textbf{\imprimircoorientador} \\ \imprimirinstCoorientador\\ (Coorientadora)}&\\ 
        ...
        \assinatura{\textbf{\imprimirbancasegundomembroexterno} \\ \imprimirbancainstsegundomembroexterno}&\\
